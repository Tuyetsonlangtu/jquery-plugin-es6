...
$(function(){
  ...
  var berthData = {
    "0042RL": [{
      ...
      "depth": null,
      "direction": "0042RL",
      "start_position_original": 650
    }], "berth_total_width": 950
  }
  ...
  $("#berth-right-tools").berthRightTools({
    ...
    onMouseRightClick: function(event, data) {
      console.log("data: ", data);
    }
  });
